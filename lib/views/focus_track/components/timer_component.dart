      ...
      builder: (context, Box box, _) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            controller.initTimerState(key, data['totalSeconds']);
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          SizedBox(width: 60, height: 60, child: CircularProgressIndicator(value: progress, strokeWidth: 4, valueColor: AlwaysStoppedAnimation(isFinished ? Colors.transparent : Colors.blue))),
          Icon(isFinished ? Icons.refresh : (isRunning ? Icons.pause : Icons.play_arrow), color: isFinished ? Colors.orange : Colors.blue),
        ],
      ),
    );
  }
